...
| `MEDLINER_LLM_URL` | local LLM server for `make shorten` and `make synthesize` (default `http://127.0.0.1:8080`, started by `make llm`; set `MODELS_DIR` for the model checkout) |
